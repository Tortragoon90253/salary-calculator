...
|---|---|---|
| `DAILY_LIMIT` | `60` | จำนวนครั้งต่อ 1 รหัสต่อวัน — ⚠️ คำถามแนว "ถ้า…จะเป็นยังไง" (จำลองสถานการณ์) ใช้ **2 ครั้ง** ต่อ 1 คำถาม (รอบแรกสั่งจำลอง รอบสองอธิบายผล) ถ้าเจอ "ใช้ครบโควตาวันนี้แล้ว" เร็วกว่าที่คิด ให้เพิ่มค่านี้ |
